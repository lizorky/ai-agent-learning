...
assert.equal(later.state.animationTime, paused.state.animationTime, 'animation and loot clocks must freeze during pause');
assert.deepEqual(later.state.combatEffects, paused.state.combatEffects, 'combat effect lifetimes must freeze during pause');
assert.deepEqual(later.state.drops, paused.state.drops, 'loot must remain available during pause');
